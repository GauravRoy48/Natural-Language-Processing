...
bayes_accuracy = sum(cm.diagonal())/cm.sum()
bayes_precision = cm[1][1]/(cm[0][1] + cm[1][1])
bayes_recall = cm[1][1]/(cm[1][1]+cm[1][0])
bayes_f1score = 2*bayes_precision*bayes_recall/(bayes_precision+bayes_recall)
