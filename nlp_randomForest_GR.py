...
#               Restaurant_Reviews.tsv. It uses Random Forest as classification model.
#######################################################################################
...
rfc_accuracy = sum(cm.diagonal())/cm.sum()
rfc_precision = cm[1][1]/(cm[0][1] + cm[1][1])
rfc_recall = cm[1][1]/(cm[1][1]+cm[1][0])
rfc_f1score = 2*rfc_precision*rfc_recall/(rfc_precision+rfc_recall)
